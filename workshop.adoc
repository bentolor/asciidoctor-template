...
[TIP]
https://docs.asciidoctor.org/asciidoc/latest/syntax-quick-reference/ might help you to for help.
--

[column]
--
image:media/workshop-challenge1.png[Workshop Challenge #1, role=right, height=600]
--
